from MountainCar.test_mountaincar import test
...
from MountainCar.test_mountaincar import calculate_fidelity
from MountainCar.test_mountaincar import run_abstract_episode
import matplotlib.pyplot as plt
from explain_utils import graph_scores
from explain_utils import cluster_data


def mountaincar_xrl(model_path, num_episodes=10, k=3):
    ...
    translator = MountainCarPredicates(num_feats=2)
    ...
    attr_names = ['Car Position', 'Car Velocity', 'State Value', 'Action']
    ...
    """
    graph_scores('mountain', alpha, lengths, 
    ...
    for h, clusters in enumerate(best_clusters):
        ...
        #print('Mountain Car CLTree Clustering Fidelity: ', fidelity)
