...
def run(env_name=None, eval_epi_no=100):
  ...
  for eps in epsilon_list:
        ...
        recRL_experiment_data = run_comparison(env=env, env_model_path= RecRL_model_path, atk_rt=atk_rate, eps=epsilon, aaa_agent_path=shield_path, aaa_cfg=adv_cfg, eval_episode= eval_epi_no)
