...
def parse_maze():
    ...
    #=======================SAC======================================================
    parser.add_argument('--saved_model_path', default='/AdvEx_RL_Trained_Models/Victim/Jul-28-2022_03_41_AM_SAC_maze_Gaussian/victim_agent/Agent_model/Best_Agent_Model/DateTime_Jul-28-2022_reward_-0.0', help='exterior log directory')
...
def parse_nav1():
    ...
    parser.add_argument('--model_path', default='None', help='Loaded model dir')
    #=======================SAC======================================================
    parser.add_argument('--saved_model_path', default='/AdvEx_RL_Trained_Models/Victim/Jul-29-2022_04_30_AM_SAC_nav1_Gaussian/victim_agent/Agent_model/Best_Agent_Model/DateTime_Jul-29-2022_reward_-6.207633963897395', help='exterior log directory')
